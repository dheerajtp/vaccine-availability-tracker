    ...
    <div className="p-3">
      <div className="card mx-auto shadow p-3 mb-5 rounded">
        <div className="card-body">
          ...
          <p class="card-text text-primary">Block Name : {block}</p>
          <p class="card-text text-primary">Pincode : {pin}</p>
...
export default ShowDistrictDetails;
